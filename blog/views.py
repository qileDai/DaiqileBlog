...
def index(request):
    ...
    # try:
    #     contans = paginator.page(page)
    # except PageNotAnInteger:
    #     contans = paginator.page(paginator.num_pages)
...
def permission_denied(request):
    return render(request,'blog/page403.html', locals())

def page_not_found(request):
    return render(request,'blog/page404.html', locals())

def page_error(request):
    return render(request,'blog/page500.html', locals())
